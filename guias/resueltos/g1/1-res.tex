...
\begin{document}
    ...
    \section*{Ejercicio 6}
        \subsection*{Inciso A}
            Si le hacemos una oferta a un no-churner (un falso positivo) va a ser costoso para la empresa, por eso el banco piensa ser más selectivo y enviar pocas ofertas a clientes. Por eso, conviene maximizar precision. Para hacerlo, conviene usar un \(\beta < 1\) porque va cambiar cómo premia los modelos con alta precision aunque tengan menos recall.
        \subsection*{Inciso B}
            \begin{center}
    ...
    \section*{Ejercicio 7}
        \subsection*{Pregunta 1}
            El problema está en el inciso C, con el oversampling.
        \subsection*{Pregunta 2}
            El problema es que, como se está oversampleando la clase minoritaria, se generan datos muy parecidos a los que ya existen o incluso pueden haber duplicados en el conjunto de test y/o de validación. Por lo tanto, en entrenamiento el modelo va a reconocer observaciones muy parecidas a otras y no va a aprender adecuadamente, y resultará en una elección de hiperparámetros optimista. Las métricas de rendimiento van a estar infladas y, claramente, va a terminar rindiendo mal en observaciones nuevas.
        \subsection*{Pregunta 3}
            Se debería cambiar cuándo hacer el oversampling. Primero se tiene que dividir en entrenamiento y validation, y hacer oversampling en el subconjunto de entrenamiento, para que las observaciones sintéticas no joroben al validation set.
\end{document}
